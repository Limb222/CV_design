...
min_confidence=0.5 最小置信值，用于过滤比较小概率的检测框
nms_threshold=0.3 NMS 阈值，与HOG+SVM一样设为 0.3
'''

def YOLO_detector(image_path, YOLO_path, min_confidence=0.5, nms_threshold=0.3):
    # load input image
    image = cv2.imread(image_path)
    # derive the paths to the YOLO weights and model configuration
    configPath = YOLO_path[0]
    weightsPath = YOLO_path[1]
    ...
    # perform a forward pass of the YOLO object detector, giving us our bounding boxes and
